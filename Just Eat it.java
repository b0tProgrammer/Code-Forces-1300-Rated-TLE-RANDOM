...
//            Comparator<Pair> com = Comparator.comparingInt(i -> i.v1);
            ...
            while (testcases-- > 0) {
                /*
                    Calculate the maximum sum sub array whose length != n;
                    and if it is greater than the overall sum, NO
                    else YES
                 */
                ...
                // calculate the max sub array whose size != n;
                // so let's take the sub array of 0 to siz-2 && 1 to siz-1

                long sum1 = kadane(0,siz-1,nums);
                long sum2 = kadane(1,siz,nums);
