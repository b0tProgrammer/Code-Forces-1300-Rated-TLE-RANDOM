    ...
    public static void main(String[] args) {
        try {
            ...
            while (testcases-- > 0) {
                ...
                // Divide and equalize, In this we have to make sure that each and every element in the array becomes equal after performing tte operation

                // the operation is that we have to divide a particular element with it's divisor and then multiply that divisor to any other element!

                // U can do the above operation any number of times, but you should say whether all elements can be made equal or not!

                // counting the number of primeFactors of each number!
