    ...
    public static void main(String[] args) {
        try {
            ...
            while (testcases-- > 0) {
                ...
                /*
                    we have to calculate the number of indices k such that at last we can make all them into 1
                    this can be done with the help of ranges given in the queries!
                ...
                for(int i = 1; i <= m; i++) {
                    ...
                    else { // intersecting part!
                        l = min(l1,l);
                        r = max(r1,r);
                    }
                }

                out.println(r-l+1); // we can convert all the indices between the min and max index in the given ranges!
