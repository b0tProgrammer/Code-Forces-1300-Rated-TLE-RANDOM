        ...
        try {
            ...
            while (testcases-- > 0) {
                ...
                /*
                    ...
                    In this, we will choose a 'k' value and select k elements in the array and find bitwise - and of all those!

                    after finding that bitwise - and, we will subtract that value from the selected k elements

                    and in this way, we have to find all the possible k's so that we can make the array all zero's

                 */

                /*
                    This can be done by using the array which stores the setBits at that position for every number and finally if any i from 1 to n divides the count of setBits in that particular position we can find the answer
                 */
