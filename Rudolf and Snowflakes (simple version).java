    ...
    public static void main(String[] args) {
        try {
            ...
            while(testcases-- > 0) {
                ...
                /*
                    Rudolf and snowFlakes!

                    In this, we have to say whether we can form a symmetrical graph from the given number of nodes!

                    this can be done!

                    with the help of math formula!

                    in this, we know the smallest possible is from k = 2;

                    and from k*(k+1)-> for every 1 node there are extra k nodes and those are connected+1->to the main vertex!

                 */

                int nodes = in.nextInt();

                print(poss[nodes],out);
