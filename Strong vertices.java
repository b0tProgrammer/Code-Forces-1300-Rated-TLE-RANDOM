    ...
    public static void main(String[] args) {
        try {
            ...
            while(testcases-- > 0) {
                ...
                /*
                    In this the question is not merely based on the graphs but this is based on the arrays!

                    we will be given two arrays a and b

                    in this we have to select the indices which follow this condition!

                    ai-bi > cxza= aj-bj

                    i.e we have to choose them in a sorted order and we have to print till the highest element remains!
                 */
                ...
                for(int i = 0; i < siz; i++) a[i] = in.nextInt();

                for(int i = 1; i <= siz; i++) {
                    int bi = in.nextInt();
                    pq.add(new Pair(a[i-1]-bi,i));
                }
                ...
                int el = pq.getLast().v1;

                int i = siz-1;

                while(i >= 0 && el == pq.get(i).v1) {
                    ans.add(pq.get(i).v2);
                    i--;
                }
