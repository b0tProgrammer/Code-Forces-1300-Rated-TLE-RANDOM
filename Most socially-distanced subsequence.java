    ...
    public static void main(String[] args) {
        try {
            ...
            while (testcases-- > 0) {
                ...
                // now we have to arrange them in this way :
                /*
                    find the peaks!
                    i.e if the current element is smaller than the before and also smaller than the after then its a peak!
                 */
                ...
                ans.add(nums[0]); // we all know that the ends are always peek!
