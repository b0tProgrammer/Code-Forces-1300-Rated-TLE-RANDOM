...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            while (testcases-- > 0) {
                /*
                    Make it alternating! In this we have a string which contains only 1's and 0's.
                    Then we have to print two values! One is the minimum number of characters should be removed to make that string alternating!
                    Alternating refers that the curr current character is unique to its neighbours!
                    the number of different shortest sequences of operations that make string alternating. Two sequences of operations are different if in at least one operation, the chosen integer 'i' is different in these two sequences
                    Now, we can do that in the following way!
                 */
                ...
                for(int l = 0; l < n;) {
                    int r = l+1;
                    while(r < n && s.charAt(l) == s.charAt(r)) // belongs to the same set!
                    {
                        r++;
                    }
                    k--;
                    ans = update(ans,(r-l)); // possibilities for every number selection in a set!
                    l = r;
                }
